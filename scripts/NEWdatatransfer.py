...
source_image_dir = "C:/Users/odezz/source/MinecraftAI2/screenshots"
source_label_dir = "C:/Users/odezz/source/MinecraftAI2/yolov8/manual_data"
...
label_files = sorted([f for f in os.listdir(source_label_dir) if f.endswith('.txt')])
...
def move_files(file_pairs, dataset_type):
    for img_file, lbl_file in file_pairs:
        ...
        lbl_src = os.path.join(source_label_dir, lbl_file)
